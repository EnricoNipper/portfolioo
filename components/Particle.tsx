...
// importar {loadFull} de "tspartículas"; // se você for usar `loadFull`, instale o pacote "tsparticles" também.
import { loadSlim } from "tsparticles-slim"; //  se você for usar `loadSlim`, instale o pacote "tsparticles-slim" também
