   ...
   // Seção de portfólio // Título da seção
    <section className="py-10 "> 
      <div> 
        ...
        <p className="text-md text-center  p-2 leading-8 text-gray-800 dark:text-gray-200">  {/* // Descrição do portfólio  */}  
        ...
        <p className="text-center  text-md py-2 leading-8 text-gray-800 dark:text-gray-200"> {/* Descrição do portfólio  */} 
