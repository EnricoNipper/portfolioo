            ...
            <ul className="flex items-center"> {/* Lista de itens na barra de navegação */}
              <li>
                <BsFillMoonStarsFill
                  ...
                  className=" cursor-pointer text-2xl" // Define o estilo do ícone
                />
              </li>
              <li>
                <Link href={pathname} locale='en' className=" cursor-pointer  px-4 py-2 rounded-md ml-8 hover:bg-cyan-500">  English {/* Link para a versão em inglês */}
                 </Link> 
              </li>
              <li>
